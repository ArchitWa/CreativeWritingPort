...
import PieceOneText from './PieceOneText';
...
export default function PieceOne() {
    ...
    const handleClick = (num) => {
        ...
        if (num === 0) setIsHomePageAnimated(true);
        if (num === 2) {
    ...
    return (
        <div>
            <div className={`home-page border absolute z-[3] bg-platinum border-platinum w-[3%] h-[80rem]  shadow ${isHomePageAnimated ? "home-page-open" : ""}`}>
                ...
                <div className={`${isHomePageAnimated ? "" : "hidden"}`}>
                    <HomeText />
                </div>
            </div>

            <div className={`piece-one-page border absolute z-[2] left-[3%] bg-bittersweet-300 border-bittersweet-300 w-[94%] h-[80rem]  shadow ${isP1PageAnimated ? "p1-page-close" : ""}`}>
                <div className='piece-one-page-text mr-[0.3rem]'>
                    <div className="nav-text unselectable" style={{ fontFamily: "akshar" }}>
                        <span>P</span><br />
                        <span>I</span><br />
                        <span>E</span><br />
            ...
            <div className={`piece-two-page border absolute z-[1] left-[6%] bg-oxford-blue-200 border-oxford-blue-200 w-[94%] h-[80rem]  shadow  ${isP2PageAnimated ? "p2-page-close" : ""}`}>
